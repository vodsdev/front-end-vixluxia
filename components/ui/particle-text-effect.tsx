...
const DEFAULT_WORDS = ["HELLO", "VIXLUXIA", "ParticleTextEffect", "BY", "mx.knife"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black w-full h-full p-4 relative">
      <canvas
        ref={canvasRef}
