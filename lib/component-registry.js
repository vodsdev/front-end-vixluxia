...
export const AUTHORS = [
  ...
  },
  {
    ...
    name: 'bry Vods.off',
    username: '@vodsoff',
    role: 'Co-fondateur & UI/UX Designer',
    avatar: 'BV',
    bio: 'Designer UI/UX de VixLuxia.',
    links: { github: 'vodsdev', instagram: 'https://www.instagram.com/max_vods/' },
  },
];
...
export function getAuthorsWithStats() {
  ...
  return AUTHORS.map((author) => {
    ...
    return {
      ...author,
      stats: totals,
      tags: author.id === 'vodsdev' || author.id === 'bry_vodsoff' 
